...
public abstract class Tier2POA extends org.omg.PortableServer.Servant
 implements simo.mi6.project.tier2.Tier2Operations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // tier2/Tier2/createNewTweet
       {
         ...
         boolean $result = false;
         $result = this.createNewTweet (username, tweet);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
       ...
       case 4:  // tier2/Tier2/getTweetsForUser
       {
         ...
         out = $rh.createReply();
         simo.mi6.project.tier2.StringsHelper.write (out, $result);
         break;
       }
